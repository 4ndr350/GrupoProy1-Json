...
public class Comprador extends Usuario {
    ...
    /**
     * Línea de recibo con desglose por item.
     */
    ...
    /**
     * Versión compatible: espera elementos de tipo ItemCompra en la lista.
     ...
     * - Valida disponibilidad y límite por transacción por evento
    ...
    public Recibo comprarTiquetes(List<ItemCompra> items, String medioPago, Administrador admin) {
        ...
        // Calculo de totales y generación de líneas
